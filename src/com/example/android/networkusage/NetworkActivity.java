...
import com.example.android.networkusage.StackOverflowXmlParser.Sale;
...
//        String summary = null;
        ...
        // a text summary.
        for (Sale entry : entries) {
            htmlString.append("<p><a href='");
            htmlString.append(entry.earnings);
            htmlString.append("'>" + entry.title + "</a></p>");
            // If the user set the preference to include summary text,
            // adds it to the display.
            if (pref) {
                htmlString.append(entry.thumbnailUrl);
            }
        }
